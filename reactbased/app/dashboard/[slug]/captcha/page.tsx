            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                {captchaType === "cloudable" && (
                  <div className="mt-4">
                    <span className="font-medium">
                      Cloudable Captcha Challenge Type
                    </span>
                    <Select
                      value={cloudableChallenge}
                      onValueChange={setCloudableChallenge}
                    >
                      <SelectTrigger className="mt-2 w-full md:w-1/2">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        ...
                        <SelectItem value="image_selection">
                          Image Selection
                        </SelectItem>
                        <SelectItem value="audio">Audio</SelectItem>
                        <SelectItem value="image_text">Image Text</SelectItem>
                        <SelectItem value="basic_click_mouse_tracking">
                          Basic Click + Mouse Tracking
                        </SelectItem>
                    ...
                    <div className="mt-2">
                      <span className="text-xs text-muted-foreground">
                        Choose the type of challenge users will solve for
                        Cloudable Captcha.
                      </span>
                    </div>
                  </div>
                    ...
                    <div className="relative min-h-[32px]">
                      ...
                      >
                        ...
                        {difficulty === "hard" && (
                          ...
                          >
                            Hard: Strongest protection, may challenge real
                            users.
                          </motion.div>
                        )}
                      </AnimatePresence>
