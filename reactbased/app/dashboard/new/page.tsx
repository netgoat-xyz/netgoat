      ...
      <div className="flex items-center justify-between">
        ...
        <div
          className={cn(
            ...
            checked ? "border-primary bg-primary" : "border-muted-foreground group-hover:border-foreground/60",
          )}
        >
          {checked && <div className="h-full w-full rounded-full bg-primary-foreground scale-50" />}
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className="space-y-6 p-5">
      <div className="space-y-1">
        <h1 className="text-2xl font-semibold tracking-tight">Add New Domain</h1>
        <p className="text-muted-foreground">Configure your domain settings and DNS records</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter your domain name and choose how to configure DNS records</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <Input id="domain-name" placeholder="example.com" className="h-11" />
            </div>

            <div className="space-y-4">
              <Label className="text-sm font-medium">DNS Configuration Method</Label>
              ...
              <Label className="group flex cursor-pointer items-start gap-4 rounded-lg border border-border p-4 transition-colors hover:bg-accent/50">
                ...
                <div className="flex-1 space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-foreground">Automatically scan for DNS Records</span>
              ...
              <Label className="group flex cursor-pointer items-center gap-4 rounded-lg border border-border p-4 transition-colors hover:bg-accent/50">
                <Checkbox id="manual" className="data-[state=checked]:bg-primary data-[state=checked]:border-primary" />
                <FileText className="h-4 w-4 text-muted-foreground" />
                <span className="font-medium text-foreground">Manually input records</span>
              </Label>
              ...
              <Label className="group flex cursor-pointer items-center gap-4 rounded-lg border border-border p-4 transition-colors hover:bg-accent/50">
                ...
                <span className="font-medium text-foreground">Upload a DNS zone file</span>
              </Label>
            </div>
          </CardContent>
        </Card>
        ...
        {/* Mode Select */}
          ...
          <CardHeader>
            ...
            <CardDescription>Configure how AI bots and crawlers interact with your website</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid gap-3 sm:grid-cols-3">
              {[
                ...
                { label: "Both DNS And Reverse Proxy", value: "BothDNSnReverse" },
              ].map((opt) => (
                <DNSOrRev
                  key={opt.value}
                  value={opt.value}
          ...
          <CardContent className="space-y-6">
            ...
            <Label className="flex cursor-pointer items-center gap-3 rounded-lg border border-border p-4 transition-colors hover:bg-accent/50">
              <Checkbox
                ...
                className="data-[state=checked]:bg-primary data-[state=checked]:border-primary"
              />
              <span className="font-medium text-foreground">Manage AI bot traffic with robots.txt</span>
            </Label>
          </CardContent>
        </Card>
