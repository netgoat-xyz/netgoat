  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        A Cloudflare alternative for local and cloud use, can be used ontop of
        cloudflare for cloudflares paid features, but for free!
      </p>
      <div className="mt-10 flex justify-center gap-x-6">
        <Button href="https://github.com/cloudable-dev/netgoat">
          Coming soon.
        </Button>
