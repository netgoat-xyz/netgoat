...
const historyItems: HistoryItem[] = [
  {
    ...
    description:
      "Successfully migrated to new database infrastructure with improved performance.",
    status: "resolved",
  },
  {
    id: "2",
    ...
    description:
      "Experienced increased API response times. Issue was identified and resolved.",
    status: "resolved",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    description:
      "CDN provider experienced brief outage affecting content delivery.",
    status: "resolved",
  },
];
const statusConfig = {
          ...
          {historyItems.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute left-3 top-6 ${config.bgColor} ${config.borderColor} border-2 p-2 rounded-lg`}
                >
